 ...
 */
npz2100_err_t npz2100_probe(const npz2100_hal_t *hal);
 ...
 * @return NPZ2100_OK or an error code.
 */
npz2100_err_t npz2100_periph_read_value(const npz2100_hal_t *hal,
 ...
 */
npz2100_err_t npz2100_sram_write(const npz2100_hal_t *hal,
                                  npz2100_config_t    *cfg,
                                  uint8_t              sram_addr,
                                  const uint8_t       *data,
                                  size_t               len);
 ...
 */
npz2100_err_t npz2100_sram_read(const npz2100_hal_t *hal,
                                 npz2100_config_t    *cfg,
                                 uint8_t              sram_addr,
                                 uint8_t             *data,
                                 size_t               len);
 ...
 * @return NPZ2100_OK or an I²C error.
 */
npz2100_err_t npz2100_enter_idle(const npz2100_hal_t *hal);
 ...
 * @return NPZ2100_OK or an I²C error.
 */
npz2100_err_t npz2100_soft_reset(const npz2100_hal_t *hal);
